...
import dev.ogabek.java.adapter.DepartmentAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerView, rv_fashion, rv_popular, rv_books, rv_department;
    ...
    private void initViews() {
        ...
        rv_department = findViewById(R.id.rv_departments);
        ...
        rv_department.setLayoutManager(new GridLayoutManager(this, 2));
        ...
        rv_department.setAdapter(new DepartmentAdapter(getDepartments()));
    ...
    private List<Department> getDepartments() {
        ...
        department.add(new Department(R.drawable.department_beauty, "Beauty"));
        department.add(new Department(R.drawable.department_clothes, "Clothes"));
        department.add(new Department(R.drawable.department_sport, "Sport"));
        department.add(new Department(R.drawable.department_technology, "Technology"));
        department.add(new Department(R.drawable.department_pet_supplies, "Pet and Supplies"));
        department.add(new Department(R.drawable.department_home_and_kitchen, "Home and Kitchen"));
        return department;
    }
